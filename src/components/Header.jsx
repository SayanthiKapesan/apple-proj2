...
<div className='absolute  text-center top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 '>
<h1 className='text-5xl font-bold p-3' >Mother's Day</h1>
<p className='font-bold text-xl'>It's not too late to find a gif for mother</p>
<button className=' mt-3 p-3 bg-blue-600 text-white rounded-xl hover:text-black'>  Shop Now</button>
</div>
</div>
</header>
