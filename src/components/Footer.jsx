...
function Footer() {
  ...
  return (
    <footer className='bg-gray-200'>
      <div className="w-[900px] px-20 p-3 max-w-6xl mx-auto  py-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
...
className="mt-4 flex flex-col md:flex-row justify-between  items-start md:items-center border-t border-gray-300">
 <p className="text-xs text-gray-500 mt-5 ">Copyright © 2023 Apple Inc. All rights reserved.
    ...
    <div className="flex flex-wrap gap-4 mt-4 md:mt-5 ">
 ...
 <a href="#" className="text-xs text-gray-500 hover:underline">
    <span className='p-1'>|</span>Site Map</a>
          ...
          <p className="text-xs text-gray-500 mt-10 md:mt-0 ml-10">
            Switzerland
          </p>
        </div>
      </div>
